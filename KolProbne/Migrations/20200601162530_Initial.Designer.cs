...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KolProbne.Models.Klient", b =>
            {
            ...
            modelBuilder.Entity("KolProbne.Models.Pracownik", b =>
            {
            ...
            modelBuilder.Entity("KolProbne.Models.WyrobCukierniczy", b =>
            {
            ...
            modelBuilder.Entity("KolProbne.Models.Zamowienie", b =>
            {
            ...
            modelBuilder.Entity("KolProbne.Models.Zamowienie_WyrobCukierniczy", b =>
            {
                b.Property<int>("IdWyrobuCukierniczego")
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("KolProbne.Models.Zamowienie", b =>
            {
                b.HasOne("KolProbne.Models.Klient", "Klient")
                    .WithMany("Zamowienia")
                    .HasForeignKey("IdKlient")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("KolProbne.Models.Pracownik", "Pracownik")
                    .WithMany("Zamowienia")
            ...
            modelBuilder.Entity("KolProbne.Models.Zamowienie_WyrobCukierniczy", b =>
            {
                b.HasOne("KolProbne.Models.WyrobCukierniczy", "WyrobCukierniczy")
                    .WithMany("Zamowienie_WyrobCukiernicze")
                    .HasForeignKey("IdWyrobuCukierniczego")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.HasOne("KolProbne.Models.Zamowienie", "Zamowienie")
                    .WithMany("Zamowienie_WyrobCukiernicze")
